...
[![Forked from a16z/ai-town](https://img.shields.io/badge/fork%20of-a16z%2Fai--town-purple)](https://github.com/a16z-infra/ai-town)
...
本仓库依 MIT 协议发布（见 [`LICENSE`](LICENSE)）。`ai-town-fork/` 子目录中继承自上游的文件依 Apache 2.0 协议（见 `ai-town-fork/LICENSE`），文件清单见 `ai-town-fork/UPSTREAM_FILES.txt`。
