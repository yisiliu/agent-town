    ...
    <main className="relative flex min-h-screen flex-col items-center justify-between font-body game-background">
      ...
      >
        <div className="font-body">
          ...
          <p>
            登录后，你可以加入这个模拟世界，直接和不同的 AI 角色对话！点「加入」按钮，你的角色会出现在地图上，脚下有个亮圈标记你自己。
          </p>
          <p className="text-2xl mt-2">操作方式：</p>
          <p className="mt-4">点击地图任意位置即可移动。</p>
          <p className="mt-4">
            想和某个 AI 聊天，点击 TA，然后点「发起对话」，TA 会朝你走过来。TA 走到你旁边就能开聊。随时关掉面板或走开就结束。AI 也可能主动来邀请你——这时右侧面板会出现「接受」按钮。
          </p>
          <p className="mt-4">
